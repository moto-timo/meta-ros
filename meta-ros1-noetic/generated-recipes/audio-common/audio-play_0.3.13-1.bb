...
# matches with: https://github.com/ros-gbp/audio_common-release/archive/release/noetic/audio_play/0.3.13-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/audio_play"
SRC_URI = "git://github.com/ros-gbp/audio_common-release;${ROS_BRANCH};protocol=https"
SRCREV = "1a30d55ade9aa3883cf5085922d2e5fc4153e9fb"
S = "${WORKDIR}/git"
