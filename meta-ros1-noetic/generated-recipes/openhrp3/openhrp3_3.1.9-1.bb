...
ROS_BUILD_DEPENDS = " \
    ...
    ${ROS_UNRESOLVED_DEP-jython} \
    ${ROS_UNRESOLVED_DEP-libpng12-dev} \
...
# matches with: https://github.com/tork-a/openhrp3-release/archive/release/noetic/openhrp3/3.1.9-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/openhrp3"
SRC_URI = "git://github.com/tork-a/openhrp3-release;${ROS_BRANCH};protocol=https"
SRCREV = "afc9ca1a682cb01bf166eb8223439fb054f3e07f"
S = "${WORKDIR}/git"
