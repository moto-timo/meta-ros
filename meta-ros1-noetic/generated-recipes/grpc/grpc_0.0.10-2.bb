...
# matches with: https://github.com/CogRobRelease/catkin_grpc-release/archive/release/noetic/grpc/0.0.10-2.tar.gz
ROS_BRANCH ?= "branch=release/noetic/grpc"
SRC_URI = "git://github.com/CogRobRelease/catkin_grpc-release;${ROS_BRANCH};protocol=https"
SRCREV = "a836b04cdd40a6d08585523198b0ab3a7764e14b"
S = "${WORKDIR}/git"
