...
# matches with: https://github.com/rm-controls/rm_control-release/archive/release/noetic/rm_dbus/0.1.9-3.tar.gz
ROS_BRANCH ?= "branch=release/noetic/rm_dbus"
SRC_URI = "git://github.com/rm-controls/rm_control-release;${ROS_BRANCH};protocol=https"
SRCREV = "0e3e07fa41c05ac549d6697ed87cd1e593594c13"
S = "${WORKDIR}/git"
