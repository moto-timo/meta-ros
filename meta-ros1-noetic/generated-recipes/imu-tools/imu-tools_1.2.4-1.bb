...
# matches with: https://github.com/uos-gbp/imu_tools-release/archive/release/noetic/imu_tools/1.2.4-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/imu_tools"
SRC_URI = "git://github.com/uos-gbp/imu_tools-release;${ROS_BRANCH};protocol=https"
SRCREV = "ea2353bd394739fa434945d0e08aab8bbe59136a"
S = "${WORKDIR}/git"
