...
# matches with: https://github.com/roboception-gbp/rc_reason_clients_ros-release/archive/release/melodic/rc_reason_msgs/0.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/rc_reason_msgs"
SRC_URI = "git://github.com/roboception-gbp/rc_reason_clients_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "c4d5a0ae59565dfb15ddbe348ad053db3ca6f9ea"
S = "${WORKDIR}/git"
