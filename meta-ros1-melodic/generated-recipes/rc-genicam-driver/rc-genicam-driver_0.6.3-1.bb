...
# matches with: https://github.com/roboception-gbp/rc_genicam_driver_ros-release/archive/release/melodic/rc_genicam_driver/0.6.3-1.tar.gz
...
SRCREV = "04f055507b825be848b0d3cb5cbbf07ba99fbc40"
S = "${WORKDIR}/git"
