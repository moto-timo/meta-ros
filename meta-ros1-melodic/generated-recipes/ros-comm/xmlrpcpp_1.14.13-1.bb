...
# matches with: https://github.com/ros-gbp/ros_comm-release/archive/release/melodic/xmlrpcpp/1.14.13-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/xmlrpcpp"
SRC_URI = "git://github.com/ros-gbp/ros_comm-release;${ROS_BRANCH};protocol=https"
SRCREV = "80ef6e9acc288f95a5c3001630d75a75484afcda"
S = "${WORKDIR}/git"
