...
# matches with: https://github.com/nobleo/libnabo-release/archive/release/melodic/libnabo/1.0.7-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/libnabo"
SRC_URI = "git://github.com/nobleo/libnabo-release;${ROS_BRANCH};protocol=https"
SRCREV = "0478aa4fa0a650b8b383cbacfae866e78214705f"
S = "${WORKDIR}/git"
