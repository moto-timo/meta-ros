...
ROS_TEST_DEPENDS = " \
    ${ROS_UNRESOLVED_DEP-phantomjs} \
    ${ROS_UNRESOLVED_DEP-python-selenium-pip} \
    rostest \
"
...
# matches with: https://github.com/tork-a/visualization_rwt-release/archive/release/melodic/rwt_app_chooser/0.1.1-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/rwt_app_chooser"
SRC_URI = "git://github.com/tork-a/visualization_rwt-release;${ROS_BRANCH};protocol=https"
SRCREV = "8ec1c5a8dbaa4d945fdf5b4f698198f7b83bfc4a"
S = "${WORKDIR}/git"
