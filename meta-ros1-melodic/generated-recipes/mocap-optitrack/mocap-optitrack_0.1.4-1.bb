...
# matches with: https://github.com/ros-drivers-gbp/mocap_optitrack-release/archive/release/melodic/mocap_optitrack/0.1.4-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/mocap_optitrack"
SRC_URI = "git://github.com/ros-drivers-gbp/mocap_optitrack-release;${ROS_BRANCH};protocol=https"
SRCREV = "3cd521f0c719dc5198a7a8ba39c8e260efb4aeb0"
S = "${WORKDIR}/git"
