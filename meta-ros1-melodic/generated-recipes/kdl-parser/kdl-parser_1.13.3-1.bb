...
# matches with: https://github.com/ros-gbp/kdl_parser-release/archive/release/melodic/kdl_parser/1.13.3-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/kdl_parser"
SRC_URI = "git://github.com/ros-gbp/kdl_parser-release;${ROS_BRANCH};protocol=https"
SRCREV = "ea504b05f34457fdeb3726d9ecf77f8f7e788eb9"
S = "${WORKDIR}/git"
