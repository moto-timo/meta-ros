...
# matches with: https://github.com/mavlink/mavros-release/archive/release/melodic/test_mavros/1.13.0-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/test_mavros"
SRC_URI = "git://github.com/mavlink/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "87ff7b6086346054fe02bc04b8e32cf68cdbec11"
S = "${WORKDIR}/git"
