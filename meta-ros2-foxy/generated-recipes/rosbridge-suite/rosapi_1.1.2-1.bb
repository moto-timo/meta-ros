...
# matches with: https://github.com/ros2-gbp/rosbridge_suite-release/archive/release/foxy/rosapi/1.1.2-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/rosapi"
SRC_URI = "git://github.com/ros2-gbp/rosbridge_suite-release;${ROS_BRANCH};protocol=https"
SRCREV = "bf5e2ec86e0c63054abc3b4da05acee6fcb017e4"
S = "${WORKDIR}/git"
