...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/foxy/rosbag2_tests/0.3.9-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/rosbag2_tests"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "91bbec488850131b7fcc5cadf794a750c05456f9"
S = "${WORKDIR}/git"
