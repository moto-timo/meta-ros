...
# matches with: https://github.com/ros2-gbp/tvm_vendor-release/archive/release/foxy/tvm_vendor/0.8.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/tvm_vendor"
SRC_URI = "git://github.com/ros2-gbp/tvm_vendor-release;${ROS_BRANCH};protocol=https"
SRCREV = "f2692baab9b1f32e61c8d2f86de5f8020de2db18"
S = "${WORKDIR}/git"
