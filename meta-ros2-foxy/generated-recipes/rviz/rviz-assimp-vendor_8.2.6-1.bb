...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/foxy/rviz_assimp_vendor/8.2.6-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/rviz_assimp_vendor"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "eb0764aec7b790fdd6bd2d8b812ea81e5f8e2624"
S = "${WORKDIR}/git"
