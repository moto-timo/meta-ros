...
# matches with: https://github.com/ros2-gbp/octomap_ros-release/archive/release/foxy/octomap_ros/0.4.2-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/octomap_ros"
SRC_URI = "git://github.com/ros2-gbp/octomap_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "e873929bf1ef561e3f8c3afc4eeb2e2a18b67e07"
S = "${WORKDIR}/git"
