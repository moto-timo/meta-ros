...
# matches with: https://github.com/ros2-gbp/performance_test_fixture-release/archive/release/foxy/performance_test_fixture/0.0.8-1.tar.gz
...
SRCREV = "a678c1e2136e5139787184c7450d1f6cad62a6e3"
S = "${WORKDIR}/git"
