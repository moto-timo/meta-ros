...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/foxy/tf2_tools/0.13.13-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/tf2_tools"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "00ce8124945fef2bd3eba94a8d44b960cc02cd86"
S = "${WORKDIR}/git"
