...
# matches with: https://github.com/ros2-gbp/iceoryx-release/archive/release/rolling/iceoryx_posh/2.0.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/iceoryx_posh"
SRC_URI = "git://github.com/ros2-gbp/iceoryx-release;${ROS_BRANCH};protocol=https"
SRCREV = "4b64f009a86377211576f4568020d5dd366fc6de"
S = "${WORKDIR}/git"
