...
# matches with: https://github.com/ros2-gbp/rcdiscover-release/archive/release/rolling/rcdiscover/1.1.4-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rcdiscover"
SRC_URI = "git://github.com/ros2-gbp/rcdiscover-release;${ROS_BRANCH};protocol=https"
SRCREV = "ec0dab3d5d46a81bf49dd6068f554775c12562a3"
S = "${WORKDIR}/git"
