...
# matches with: https://github.com/ros2-gbp/rclc-release/archive/release/rolling/rclc_parameter/3.0.8-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rclc_parameter"
SRC_URI = "git://github.com/ros2-gbp/rclc-release;${ROS_BRANCH};protocol=https"
SRCREV = "cb6b2563679f1f423a8c0172ca7ed8e50e5a4976"
S = "${WORKDIR}/git"
