...
ROS_BUILD_DEPENDS = " \
    ${ROS_UNRESOLVED_DEP-moveit-common} \
    ${ROS_UNRESOLVED_DEP-moveit-core} \
    ${ROS_UNRESOLVED_DEP-moveit-ros-planning} \
    geometry-msgs \
    graph-msgs \
    rclcpp \
    rviz-visual-tools \
...
# matches with: https://github.com/ros2-gbp/moveit_visual_tools-release/archive/release/rolling/moveit_visual_tools/4.0.0-2.tar.gz
...
SRCREV = "d42087e4c2287fff82cfbb520d52b2ace54f8c8b"
S = "${WORKDIR}/git"
