...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/rolling/demo_nodes_py/0.20.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/demo_nodes_py"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "fd3960536a97928762e71149752fe5d3aaca3ad3"
S = "${WORKDIR}/git"
