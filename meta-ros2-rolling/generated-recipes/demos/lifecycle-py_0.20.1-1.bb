...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/rolling/lifecycle_py/0.20.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/lifecycle_py"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "f20533679bd505a7dbfa2e41d1d932455886570e"
S = "${WORKDIR}/git"
