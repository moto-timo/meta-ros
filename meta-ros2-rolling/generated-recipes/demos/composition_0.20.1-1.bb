...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/rolling/composition/0.20.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/composition"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "46765474cfc4f56c02b4808139619101ffdbcd56"
S = "${WORKDIR}/git"
