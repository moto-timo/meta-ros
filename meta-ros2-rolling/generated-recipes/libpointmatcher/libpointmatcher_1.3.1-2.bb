...
# matches with: https://github.com/ros2-gbp/libpointmatcher-release/archive/release/rolling/libpointmatcher/1.3.1-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/libpointmatcher"
SRC_URI = "git://github.com/ros2-gbp/libpointmatcher-release;${ROS_BRANCH};protocol=https"
SRCREV = "e8a3ed4bd8f170c3e9ef6e96e91e7b3dbc0e8d92"
S = "${WORKDIR}/git"
