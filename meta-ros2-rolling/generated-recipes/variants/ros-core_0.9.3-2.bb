...
# matches with: https://github.com/ros2-gbp/variants-release/archive/release/rolling/ros_core/0.9.3-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ros_core"
SRC_URI = "git://github.com/ros2-gbp/variants-release;${ROS_BRANCH};protocol=https"
SRCREV = "7248404bf53d59cb1103ee7e4f06f5b6220aeb92"
S = "${WORKDIR}/git"
