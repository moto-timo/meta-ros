...
# matches with: https://github.com/ros2-gbp/variants-release/archive/release/rolling/desktop/0.9.3-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/desktop"
SRC_URI = "git://github.com/ros2-gbp/variants-release;${ROS_BRANCH};protocol=https"
SRCREV = "1d9bcf584ac46f92d51bcf4578a0e25821f75dd1"
S = "${WORKDIR}/git"
