...
# matches with: https://github.com/ros2-gbp/variants-release/archive/release/rolling/ros_base/0.9.3-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ros_base"
SRC_URI = "git://github.com/ros2-gbp/variants-release;${ROS_BRANCH};protocol=https"
SRCREV = "a3004866f63f03c036d73a8e4545e5518d6d25fe"
S = "${WORKDIR}/git"
