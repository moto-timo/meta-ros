...
# matches with: https://github.com/ros2-gbp/locator_ros_bridge-release/archive/release/rolling/bosch_locator_bridge/2.1.5-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/bosch_locator_bridge"
SRC_URI = "git://github.com/ros2-gbp/locator_ros_bridge-release;${ROS_BRANCH};protocol=https"
SRCREV = "4385a64028ccd2fe5ca476f44a23985f2cf0d81b"
S = "${WORKDIR}/git"
