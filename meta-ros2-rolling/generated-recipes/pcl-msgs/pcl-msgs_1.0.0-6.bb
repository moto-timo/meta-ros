...
# matches with: https://github.com/ros2-gbp/pcl_msgs-release/archive/release/rolling/pcl_msgs/1.0.0-6.tar.gz
ROS_BRANCH ?= "branch=release/rolling/pcl_msgs"
SRC_URI = "git://github.com/ros2-gbp/pcl_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "cea166ec0bcef834ab48d4376baaba7d935ef94d"
S = "${WORKDIR}/git"
