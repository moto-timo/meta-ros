...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/rolling/zstd_vendor/0.15.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/zstd_vendor"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "38bd5d0e77ccc3a45ee6ddbb952d94e195308853"
S = "${WORKDIR}/git"
