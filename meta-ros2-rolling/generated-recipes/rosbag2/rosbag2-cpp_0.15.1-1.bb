...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/rolling/rosbag2_cpp/0.15.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rosbag2_cpp"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "cdb2fca3801f9c1d5734ee92beec7707f05a5ba3"
S = "${WORKDIR}/git"
