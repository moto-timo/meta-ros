...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/rolling/rosbag2_py/0.15.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rosbag2_py"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "eb884cc208b3f4c27f41307469d2e448b438605d"
S = "${WORKDIR}/git"
