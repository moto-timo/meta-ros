...
# matches with: https://github.com/ros2-gbp/fmilibrary_vendor-release/archive/release/rolling/fmilibrary_vendor/1.0.1-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/fmilibrary_vendor"
SRC_URI = "git://github.com/ros2-gbp/fmilibrary_vendor-release;${ROS_BRANCH};protocol=https"
SRCREV = "9331ddaa4f4ee1a90091a4d02e69ccffed58ab0a"
S = "${WORKDIR}/git"
