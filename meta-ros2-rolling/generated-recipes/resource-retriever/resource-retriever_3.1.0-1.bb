...
# matches with: https://github.com/ros2-gbp/resource_retriever-release/archive/release/rolling/resource_retriever/3.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/resource_retriever"
SRC_URI = "git://github.com/ros2-gbp/resource_retriever-release;${ROS_BRANCH};protocol=https"
SRCREV = "d9a29b70c2eac9a92c561d824e4d96d6cdef2ac2"
S = "${WORKDIR}/git"
