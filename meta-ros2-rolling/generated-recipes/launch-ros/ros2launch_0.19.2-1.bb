...
# matches with: https://github.com/ros2-gbp/launch_ros-release/archive/release/rolling/ros2launch/0.19.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ros2launch"
SRC_URI = "git://github.com/ros2-gbp/launch_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "1840f9a68cf512b759dd1c3366b2ab54fd0b6fde"
S = "${WORKDIR}/git"
