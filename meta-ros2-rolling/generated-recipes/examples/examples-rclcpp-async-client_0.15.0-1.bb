...
# matches with: https://github.com/ros2-gbp/examples-release/archive/release/rolling/examples_rclcpp_async_client/0.15.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/examples_rclcpp_async_client"
SRC_URI = "git://github.com/ros2-gbp/examples-release;${ROS_BRANCH};protocol=https"
SRCREV = "fcbd42d2888b33ca8a39bc0eb831ced938b07de8"
S = "${WORKDIR}/git"
