...
# matches with: https://github.com/ros2-gbp/examples-release/archive/release/rolling/examples_rclpy_minimal_action_client/0.15.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/examples_rclpy_minimal_action_client"
SRC_URI = "git://github.com/ros2-gbp/examples-release;${ROS_BRANCH};protocol=https"
SRCREV = "a23df76d2d29543f5a686b4161264b373bf8cd58"
S = "${WORKDIR}/git"
