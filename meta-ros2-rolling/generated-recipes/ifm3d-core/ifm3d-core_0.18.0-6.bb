...
# matches with: https://github.com/ros2-gbp/ifm3d-release/archive/release/rolling/ifm3d_core/0.18.0-6.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ifm3d_core"
SRC_URI = "git://github.com/ros2-gbp/ifm3d-release;${ROS_BRANCH};protocol=https"
SRCREV = "40a9bbc23f63ed49458615bf99aca830e68f84f4"
S = "${WORKDIR}/git"
