...
# matches with: https://github.com/ros2-gbp/mrt_cmake_modules-release/archive/release/rolling/mrt_cmake_modules/1.0.9-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/mrt_cmake_modules"
SRC_URI = "git://github.com/ros2-gbp/mrt_cmake_modules-release;${ROS_BRANCH};protocol=https"
SRCREV = "5150d178d3634bca18ea8dc737fe6ff57a43b9f0"
S = "${WORKDIR}/git"
