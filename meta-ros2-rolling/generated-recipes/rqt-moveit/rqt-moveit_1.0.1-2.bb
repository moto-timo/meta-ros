...
# matches with: https://github.com/ros2-gbp/rqt_moveit-release/archive/release/rolling/rqt_moveit/1.0.1-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rqt_moveit"
SRC_URI = "git://github.com/ros2-gbp/rqt_moveit-release;${ROS_BRANCH};protocol=https"
SRCREV = "b8686a3ac61d5b472ccc558e5815f97ea3a46fbb"
S = "${WORKDIR}/git"
