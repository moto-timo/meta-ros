...
# matches with: https://github.com/ros2-gbp/velodyne_simulator-release/archive/release/rolling/velodyne_description/2.0.2-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/velodyne_description"
SRC_URI = "git://github.com/ros2-gbp/velodyne_simulator-release;${ROS_BRANCH};protocol=https"
SRCREV = "2bdd444d7241b42455563f30479df065abdcec68"
S = "${WORKDIR}/git"
