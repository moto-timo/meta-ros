...
# matches with: https://github.com/ros2-gbp/zbar_ros-release/archive/release/rolling/zbar_ros/0.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/zbar_ros"
SRC_URI = "git://github.com/ros2-gbp/zbar_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "febe42f6b4fb3e2c3ca89034eeea3f05a7690b77"
S = "${WORKDIR}/git"
