...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_tools/0.25.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/tf2_tools"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "8fe49fa031db9f5bf46f72973d22a4db777bead0"
S = "${WORKDIR}/git"
