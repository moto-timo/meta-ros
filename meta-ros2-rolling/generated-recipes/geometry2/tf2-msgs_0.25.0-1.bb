...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_msgs/0.25.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/tf2_msgs"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "dfc6181a9a00f7d8efde6777995e491ec16fa8ae"
S = "${WORKDIR}/git"
