...
# matches with: https://github.com/ros2-gbp/bond_core-release/archive/release/rolling/bond_core/3.0.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/bond_core"
SRC_URI = "git://github.com/ros2-gbp/bond_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "9164d94c7933fde9abc21b0ef4c710acd015fc6a"
S = "${WORKDIR}/git"
