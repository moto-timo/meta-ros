...
# matches with: https://github.com/ros2-gbp/bond_core-release/archive/release/rolling/bondcpp/3.0.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/bondcpp"
SRC_URI = "git://github.com/ros2-gbp/bond_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "4e37d317debaff36ddd46aa28cd2e48e2739bfdc"
S = "${WORKDIR}/git"
