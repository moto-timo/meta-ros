...
# matches with: https://github.com/ros2-gbp/bond_core-release/archive/release/rolling/test_bond/3.0.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/test_bond"
SRC_URI = "git://github.com/ros2-gbp/bond_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "0571ced1d459af3bd12bc0e1c734db25108c84b7"
S = "${WORKDIR}/git"
