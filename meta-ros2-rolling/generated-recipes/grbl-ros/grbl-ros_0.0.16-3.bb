...
# matches with: https://github.com/ros2-gbp/grbl_ros-release/archive/release/rolling/grbl_ros/0.0.16-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/grbl_ros"
SRC_URI = "git://github.com/ros2-gbp/grbl_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "887620a87bd4fb8c850a49d7bd5aca81f558c996"
S = "${WORKDIR}/git"
