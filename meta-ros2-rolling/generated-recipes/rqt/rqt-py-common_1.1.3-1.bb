...
# matches with: https://github.com/ros2-gbp/rqt-release/archive/release/rolling/rqt_py_common/1.1.3-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rqt_py_common"
SRC_URI = "git://github.com/ros2-gbp/rqt-release;${ROS_BRANCH};protocol=https"
SRCREV = "7ff76d4e4fd6f76c8a333331ec6773fe8c0be3a9"
S = "${WORKDIR}/git"
