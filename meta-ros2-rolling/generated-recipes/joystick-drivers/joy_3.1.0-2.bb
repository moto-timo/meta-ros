...
# matches with: https://github.com/ros2-gbp/joystick_drivers-release/archive/release/rolling/joy/3.1.0-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/joy"
SRC_URI = "git://github.com/ros2-gbp/joystick_drivers-release;${ROS_BRANCH};protocol=https"
SRCREV = "db4b928794be7edac6512f61c33bdcbf2cef5c88"
S = "${WORKDIR}/git"
