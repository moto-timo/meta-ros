...
# matches with: https://github.com/ros2-gbp/apriltag-release/archive/release/rolling/apriltag/3.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/apriltag"
SRC_URI = "git://github.com/ros2-gbp/apriltag-release;${ROS_BRANCH};protocol=https"
SRCREV = "c46fb5972246bf271cc3045638610d77a7357cc4"
S = "${WORKDIR}/git"
