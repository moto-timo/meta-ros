...
# matches with: https://github.com/ros2-gbp/laser_geometry-release/archive/release/rolling/laser_geometry/2.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/laser_geometry"
SRC_URI = "git://github.com/ros2-gbp/laser_geometry-release;${ROS_BRANCH};protocol=https"
SRCREV = "e15861d0a5c1814172f10b16d7feba8e6a0792b4"
S = "${WORKDIR}/git"
