...
# matches with: https://github.com/ros2-gbp/gps_umd-release/archive/release/rolling/gpsd_client/1.0.4-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/gpsd_client"
SRC_URI = "git://github.com/ros2-gbp/gps_umd-release;${ROS_BRANCH};protocol=https"
SRCREV = "a1b8685ca80fc8aa2f0570f832884b1941c22b78"
S = "${WORKDIR}/git"
