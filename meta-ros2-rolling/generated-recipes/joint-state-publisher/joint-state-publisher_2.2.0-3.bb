...
# matches with: https://github.com/ros2-gbp/joint_state_publisher-release/archive/release/rolling/joint_state_publisher/2.2.0-3.tar.gz
...
SRCREV = "ece03e2e6f8057fb6cbb4a7e0592a7bbad88cb9b"
S = "${WORKDIR}/git"
