...
# matches with: https://github.com/ros2-gbp/rot_conv_lib-release/archive/release/rolling/rot_conv/1.0.11-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rot_conv"
SRC_URI = "git://github.com/ros2-gbp/rot_conv_lib-release;${ROS_BRANCH};protocol=https"
SRCREV = "2f32339820717033a768e8d4862bfd49e1438b34"
S = "${WORKDIR}/git"
