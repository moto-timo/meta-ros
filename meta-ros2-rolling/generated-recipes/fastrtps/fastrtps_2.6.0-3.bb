...
# matches with: https://github.com/ros2-gbp/fastrtps-release/archive/release/rolling/fastrtps/2.6.0-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/fastrtps"
SRC_URI = "git://github.com/ros2-gbp/fastrtps-release;${ROS_BRANCH};protocol=https"
SRCREV = "86bd4682863f7b78904e50d032cde8633827d737"
S = "${WORKDIR}/git"
