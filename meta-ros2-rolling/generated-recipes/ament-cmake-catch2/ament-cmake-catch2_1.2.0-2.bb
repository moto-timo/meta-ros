...
# matches with: https://github.com/ros2-gbp/ament_cmake_catch2-release/archive/release/rolling/ament_cmake_catch2/1.2.0-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ament_cmake_catch2"
SRC_URI = "git://github.com/ros2-gbp/ament_cmake_catch2-release;${ROS_BRANCH};protocol=https"
SRCREV = "8e5859cde022882b1f84b0861755b609526f1d50"
S = "${WORKDIR}/git"
