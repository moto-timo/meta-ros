...
# matches with: https://github.com/ros2-gbp/gazebo_ros2_control-release/archive/release/rolling/gazebo_ros2_control/0.0.8-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/gazebo_ros2_control"
SRC_URI = "git://github.com/ros2-gbp/gazebo_ros2_control-release;${ROS_BRANCH};protocol=https"
SRCREV = "07a335ffe9f3671c19b65596a6cf9cad6ae17439"
S = "${WORKDIR}/git"
