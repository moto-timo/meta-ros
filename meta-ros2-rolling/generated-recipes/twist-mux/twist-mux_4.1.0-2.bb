...
# matches with: https://github.com/ros2-gbp/twist_mux-release/archive/release/rolling/twist_mux/4.1.0-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/twist_mux"
SRC_URI = "git://github.com/ros2-gbp/twist_mux-release;${ROS_BRANCH};protocol=https"
SRCREV = "96907fa13c5942a17e5fa09b8b468dcce5f4aec3"
S = "${WORKDIR}/git"
