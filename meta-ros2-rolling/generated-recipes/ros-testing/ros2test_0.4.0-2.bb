...
# matches with: https://github.com/ros2-gbp/ros_testing-release/archive/release/rolling/ros2test/0.4.0-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ros2test"
SRC_URI = "git://github.com/ros2-gbp/ros_testing-release;${ROS_BRANCH};protocol=https"
SRCREV = "4aaa3c1b35b5d0a47146fa69d5e12ae07070097d"
S = "${WORKDIR}/git"
