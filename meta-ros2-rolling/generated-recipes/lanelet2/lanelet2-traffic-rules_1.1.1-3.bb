...
# matches with: https://github.com/ros2-gbp/lanelet2-release/archive/release/rolling/lanelet2_traffic_rules/1.1.1-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/lanelet2_traffic_rules"
SRC_URI = "git://github.com/ros2-gbp/lanelet2-release;${ROS_BRANCH};protocol=https"
SRCREV = "3e8ffdfed282074a9ed9829e22ff6eb4d96c832e"
S = "${WORKDIR}/git"
