...
# matches with: https://github.com/ros2-gbp/lanelet2-release/archive/release/rolling/lanelet2_validation/1.1.1-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/lanelet2_validation"
SRC_URI = "git://github.com/ros2-gbp/lanelet2-release;${ROS_BRANCH};protocol=https"
SRCREV = "9bcf90ee1d77ad2b20d2212c02de7a5390d3f0be"
S = "${WORKDIR}/git"
