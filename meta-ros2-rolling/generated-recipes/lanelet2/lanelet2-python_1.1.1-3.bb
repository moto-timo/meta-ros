...
# matches with: https://github.com/ros2-gbp/lanelet2-release/archive/release/rolling/lanelet2_python/1.1.1-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/lanelet2_python"
SRC_URI = "git://github.com/ros2-gbp/lanelet2-release;${ROS_BRANCH};protocol=https"
SRCREV = "aa52f5fdb038dd14f572fad83cfb8b85e249827f"
S = "${WORKDIR}/git"
