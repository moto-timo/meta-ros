...
# matches with: https://github.com/ros2-gbp/rc_genicam_driver_ros2-release/archive/release/rolling/rc_genicam_driver/0.2.1-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rc_genicam_driver"
SRC_URI = "git://github.com/ros2-gbp/rc_genicam_driver_ros2-release;${ROS_BRANCH};protocol=https"
SRCREV = "2dc240a8e3a7fd6f676b6821ff3caea61ee3dac6"
S = "${WORKDIR}/git"
