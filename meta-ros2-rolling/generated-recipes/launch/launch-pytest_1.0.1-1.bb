...
# matches with: https://github.com/ros2-gbp/launch-release/archive/release/rolling/launch_pytest/1.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/launch_pytest"
SRC_URI = "git://github.com/ros2-gbp/launch-release;${ROS_BRANCH};protocol=https"
SRCREV = "ee4d2cb7dd6df6ccc6a66635bad2c1daeb4406fd"
S = "${WORKDIR}/git"
