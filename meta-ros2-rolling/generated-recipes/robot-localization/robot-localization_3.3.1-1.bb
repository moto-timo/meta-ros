...
# matches with: https://github.com/ros2-gbp/robot_localization-release/archive/release/rolling/robot_localization/3.3.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/robot_localization"
SRC_URI = "git://github.com/ros2-gbp/robot_localization-release;${ROS_BRANCH};protocol=https"
SRCREV = "68379b4d26ddefffbccfc5d5e2eb2833616f59d5"
S = "${WORKDIR}/git"
