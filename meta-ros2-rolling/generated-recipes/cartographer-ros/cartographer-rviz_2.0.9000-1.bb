...
# matches with: https://github.com/ros2-gbp/cartographer_ros-release/archive/release/rolling/cartographer_rviz/2.0.9000-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/cartographer_rviz"
SRC_URI = "git://github.com/ros2-gbp/cartographer_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "e55778a59a024b4b70d6e0406e79e0dfdf38fba2"
S = "${WORKDIR}/git"
