...
# matches with: https://github.com/ros2-gbp/cyclonedds-release/archive/release/rolling/cyclonedds/0.9.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/cyclonedds"
SRC_URI = "git://github.com/ros2-gbp/cyclonedds-release;${ROS_BRANCH};protocol=https"
SRCREV = "2b78dcc9bb71aff3dc37eae7ce88f168aeed4f47"
S = "${WORKDIR}/git"
