...
# matches with: https://github.com/ros2-gbp/laser_proc-release/archive/release/rolling/laser_proc/1.0.2-4.tar.gz
ROS_BRANCH ?= "branch=release/rolling/laser_proc"
SRC_URI = "git://github.com/ros2-gbp/laser_proc-release;${ROS_BRANCH};protocol=https"
SRCREV = "d67a6e8d259d16a41fb578c0efc38de912a54d7b"
S = "${WORKDIR}/git"
