...
# matches with: https://github.com/ros2-gbp/micro_ros_msgs-release/archive/release/rolling/micro_ros_msgs/1.0.0-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/micro_ros_msgs"
SRC_URI = "git://github.com/ros2-gbp/micro_ros_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "1add8b6a4e44727c4018abf15dbdf337ddbf0ae4"
S = "${WORKDIR}/git"
