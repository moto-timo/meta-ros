...
# matches with: https://github.com/ros2-gbp/rmf_simulation-release/archive/release/rolling/rmf_robot_sim_ignition_plugins/1.2.0-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rmf_robot_sim_ignition_plugins"
SRC_URI = "git://github.com/ros2-gbp/rmf_simulation-release;${ROS_BRANCH};protocol=https"
SRCREV = "001c7645f3a4177923b999a1ace13ee12a9ab7ad"
S = "${WORKDIR}/git"
