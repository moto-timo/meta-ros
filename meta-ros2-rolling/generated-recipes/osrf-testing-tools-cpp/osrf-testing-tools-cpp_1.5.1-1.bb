...
# matches with: https://github.com/ros2-gbp/osrf_testing_tools_cpp-release/archive/release/rolling/osrf_testing_tools_cpp/1.5.1-1.tar.gz
...
SRCREV = "b8a6321f48b305cf44f4341c2329279065e3911f"
S = "${WORKDIR}/git"
