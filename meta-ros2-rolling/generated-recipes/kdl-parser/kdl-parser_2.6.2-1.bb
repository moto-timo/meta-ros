...
# matches with: https://github.com/ros2-gbp/kdl_parser-release/archive/release/rolling/kdl_parser/2.6.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/kdl_parser"
SRC_URI = "git://github.com/ros2-gbp/kdl_parser-release;${ROS_BRANCH};protocol=https"
SRCREV = "d7849aacabaafc788714e2a2d387611bbdffabb6"
S = "${WORKDIR}/git"
