...
# matches with: https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2multicast/0.18.3-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ros2multicast"
SRC_URI = "git://github.com/ros2-gbp/ros2cli-release;${ROS_BRANCH};protocol=https"
SRCREV = "45fd9aaf0b1a022c2306de4ecd37fcddfe03d16b"
S = "${WORKDIR}/git"
