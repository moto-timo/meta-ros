...
# matches with: https://github.com/ros-gbp/twist_mux-release/archive/release/galactic/twist_mux/4.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/twist_mux"
SRC_URI = "git://github.com/ros-gbp/twist_mux-release;${ROS_BRANCH};protocol=https"
SRCREV = "93f4c7e5a176b1157cfe654ba0d4c0a31f36c785"
S = "${WORKDIR}/git"
