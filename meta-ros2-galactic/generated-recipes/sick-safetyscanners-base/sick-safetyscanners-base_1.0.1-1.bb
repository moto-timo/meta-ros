...
# matches with: https://github.com/SICKAG/sick_safetyscanners_base-release/archive/release/galactic/sick_safetyscanners_base/1.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/sick_safetyscanners_base"
SRC_URI = "git://github.com/SICKAG/sick_safetyscanners_base-release;${ROS_BRANCH};protocol=https"
SRCREV = "fff4518e9be619df7e9e886e9bf38441cbe3d6dc"
S = "${WORKDIR}/git"
