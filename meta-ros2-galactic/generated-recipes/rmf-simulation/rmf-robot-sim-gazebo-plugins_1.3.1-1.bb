...
# matches with: https://github.com/ros2-gbp/rmf_simulation-release/archive/release/galactic/rmf_robot_sim_gazebo_plugins/1.3.1-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/rmf_robot_sim_gazebo_plugins"
SRC_URI = "git://github.com/ros2-gbp/rmf_simulation-release;${ROS_BRANCH};protocol=https"
SRCREV = "0680240fb7942d6293db3a4f06eeb7e8aa320ead"
S = "${WORKDIR}/git"
