...
# matches with: https://github.com/ros2-gbp/rmf_simulation-release/archive/release/galactic/rmf_robot_sim_ignition_plugins/1.3.1-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/rmf_robot_sim_ignition_plugins"
SRC_URI = "git://github.com/ros2-gbp/rmf_simulation-release;${ROS_BRANCH};protocol=https"
SRCREV = "b6cc84cbd781e636c4ee95d958797a4fc2b2af6a"
S = "${WORKDIR}/git"
