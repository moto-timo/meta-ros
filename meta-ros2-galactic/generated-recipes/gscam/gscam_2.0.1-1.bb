...
# matches with: https://github.com/ros2-gbp/gscam-release/archive/release/galactic/gscam/2.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/gscam"
SRC_URI = "git://github.com/ros2-gbp/gscam-release;${ROS_BRANCH};protocol=https"
SRCREV = "f1a8190193a72b5a153d144bf9c7d4686e3d8a7d"
S = "${WORKDIR}/git"
