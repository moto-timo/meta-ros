...
# matches with: https://github.com/ros2-gbp/foonathan_memory_vendor-release/archive/release/galactic/foonathan_memory_vendor/1.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/foonathan_memory_vendor"
SRC_URI = "git://github.com/ros2-gbp/foonathan_memory_vendor-release;${ROS_BRANCH};protocol=https"
SRCREV = "393cb7d44ad8d22872278dc5422c7badb28edc0a"
S = "${WORKDIR}/git"
