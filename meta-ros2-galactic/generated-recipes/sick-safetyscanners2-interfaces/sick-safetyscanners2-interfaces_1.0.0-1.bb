...
# matches with: https://github.com/SICKAG/sick_safetyscanners2_interfaces-release/archive/release/galactic/sick_safetyscanners2_interfaces/1.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/sick_safetyscanners2_interfaces"
SRC_URI = "git://github.com/SICKAG/sick_safetyscanners2_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "05e0c404b724fcc8f7fee21265e8e76adebed3e0"
S = "${WORKDIR}/git"
