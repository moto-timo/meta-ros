...
# matches with: https://github.com/ros2-gbp/webots_ros2-release/archive/release/galactic/webots_ros2_tests/1.2.2-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/webots_ros2_tests"
SRC_URI = "git://github.com/ros2-gbp/webots_ros2-release;${ROS_BRANCH};protocol=https"
SRCREV = "3ed11ef7b53dd3ee88a38d8b77fd069ad55c2268"
S = "${WORKDIR}/git"
