...
# matches with: https://github.com/ros2-gbp/velodyne_simulator-release/archive/release/galactic/velodyne_description/2.0.2-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/velodyne_description"
SRC_URI = "git://github.com/ros2-gbp/velodyne_simulator-release;${ROS_BRANCH};protocol=https"
SRCREV = "de8e572a85416eab76da68b54f9a065557bfee1a"
S = "${WORKDIR}/git"
