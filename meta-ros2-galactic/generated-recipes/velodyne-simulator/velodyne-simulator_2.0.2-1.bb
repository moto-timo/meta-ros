...
# matches with: https://github.com/ros2-gbp/velodyne_simulator-release/archive/release/galactic/velodyne_simulator/2.0.2-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/velodyne_simulator"
SRC_URI = "git://github.com/ros2-gbp/velodyne_simulator-release;${ROS_BRANCH};protocol=https"
SRCREV = "f250d8c7bd388a17b712216a3649c04cc61fdd1d"
S = "${WORKDIR}/git"
