...
# matches with: https://github.com/ros2-gbp/velodyne_simulator-release/archive/release/galactic/velodyne_gazebo_plugins/2.0.2-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/velodyne_gazebo_plugins"
SRC_URI = "git://github.com/ros2-gbp/velodyne_simulator-release;${ROS_BRANCH};protocol=https"
SRCREV = "42987476341677fcdb12677f12f3499f1d68a3bd"
S = "${WORKDIR}/git"
