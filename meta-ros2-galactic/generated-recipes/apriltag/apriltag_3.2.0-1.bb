...
# matches with: https://github.com/ros2-gbp/apriltag-release/archive/release/galactic/apriltag/3.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/apriltag"
SRC_URI = "git://github.com/ros2-gbp/apriltag-release;${ROS_BRANCH};protocol=https"
SRCREV = "2507dca81668585cc9ccddde82545d47fddbc36a"
S = "${WORKDIR}/git"
