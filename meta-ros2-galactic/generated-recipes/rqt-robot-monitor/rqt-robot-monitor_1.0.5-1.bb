...
# matches with: https://github.com/ros2-gbp/rqt_robot_monitor-release/archive/release/galactic/rqt_robot_monitor/1.0.5-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/rqt_robot_monitor"
SRC_URI = "git://github.com/ros2-gbp/rqt_robot_monitor-release;${ROS_BRANCH};protocol=https"
SRCREV = "771f14cfbc9a0fd56df74b2cfca423b47eff4828"
S = "${WORKDIR}/git"
