...
# matches with: https://github.com/ros2-gbp/ign_ros2_control-release/archive/release/galactic/ign_ros2_control_demos/0.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/ign_ros2_control_demos"
SRC_URI = "git://github.com/ros2-gbp/ign_ros2_control-release;${ROS_BRANCH};protocol=https"
SRCREV = "e9a73f4552c95b934041e7968e865f1ace09173c"
S = "${WORKDIR}/git"
