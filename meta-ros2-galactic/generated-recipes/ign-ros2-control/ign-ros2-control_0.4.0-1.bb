...
# matches with: https://github.com/ros2-gbp/ign_ros2_control-release/archive/release/galactic/ign_ros2_control/0.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/ign_ros2_control"
SRC_URI = "git://github.com/ros2-gbp/ign_ros2_control-release;${ROS_BRANCH};protocol=https"
SRCREV = "955b1489e86dd3b97f1b8304780f67bb6066c710"
S = "${WORKDIR}/git"
