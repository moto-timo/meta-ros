...
# matches with: https://github.com/ros2-gbp/octomap_ros-release/archive/release/galactic/octomap_ros/0.4.2-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/octomap_ros"
SRC_URI = "git://github.com/ros2-gbp/octomap_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "e996fb8929bfd223fa1471760939cef1e4677977"
S = "${WORKDIR}/git"
