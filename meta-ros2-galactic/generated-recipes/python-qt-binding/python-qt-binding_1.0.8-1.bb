...
# matches with: https://github.com/ros2-gbp/python_qt_binding-release/archive/release/galactic/python_qt_binding/1.0.8-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/python_qt_binding"
SRC_URI = "git://github.com/ros2-gbp/python_qt_binding-release;${ROS_BRANCH};protocol=https"
SRCREV = "b035ba536ae8b3666d0dfd8c0ec41002372179d3"
S = "${WORKDIR}/git"
