...
# matches with: https://github.com/ros2-gbp/robot_state_publisher-release/archive/release/galactic/robot_state_publisher/2.5.3-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/robot_state_publisher"
SRC_URI = "git://github.com/ros2-gbp/robot_state_publisher-release;${ROS_BRANCH};protocol=https"
SRCREV = "5ab3f01a5086ac800475ade3bafdbfec84d98e97"
S = "${WORKDIR}/git"
