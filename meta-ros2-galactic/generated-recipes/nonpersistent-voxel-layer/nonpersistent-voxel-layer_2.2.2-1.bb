...
# matches with: https://github.com/SteveMacenski/nonpersistent_voxel_layer-release/archive/release/galactic/nonpersistent_voxel_layer/2.2.2-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/nonpersistent_voxel_layer"
SRC_URI = "git://github.com/SteveMacenski/nonpersistent_voxel_layer-release;${ROS_BRANCH};protocol=https"
SRCREV = "7c2863aa6d8255369dc2b7ccabaed1929b9b5995"
S = "${WORKDIR}/git"
