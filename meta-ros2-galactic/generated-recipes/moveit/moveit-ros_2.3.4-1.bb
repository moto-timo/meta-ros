...
# matches with: https://github.com/moveit/moveit2-release/archive/release/galactic/moveit_ros/2.3.4-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/moveit_ros"
SRC_URI = "git://github.com/moveit/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "8231744980f2e73570fdd6a5c090fc0df2c05c8b"
S = "${WORKDIR}/git"
