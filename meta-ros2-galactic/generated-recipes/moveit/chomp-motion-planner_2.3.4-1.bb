...
# matches with: https://github.com/moveit/moveit2-release/archive/release/galactic/chomp_motion_planner/2.3.4-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/chomp_motion_planner"
SRC_URI = "git://github.com/moveit/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "b304018757bf8783ed69d7ad7696e42cd798b670"
S = "${WORKDIR}/git"
