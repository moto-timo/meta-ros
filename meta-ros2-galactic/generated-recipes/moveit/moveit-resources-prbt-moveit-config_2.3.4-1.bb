...
# matches with: https://github.com/moveit/moveit2-release/archive/release/galactic/moveit_resources_prbt_moveit_config/2.3.4-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/moveit_resources_prbt_moveit_config"
SRC_URI = "git://github.com/moveit/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "6f4f34b86fb4f08257f1e1f8b6e9cb8479f90235"
S = "${WORKDIR}/git"
