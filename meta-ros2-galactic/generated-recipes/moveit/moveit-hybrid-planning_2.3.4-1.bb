...
# matches with: https://github.com/moveit/moveit2-release/archive/release/galactic/moveit_hybrid_planning/2.3.4-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/moveit_hybrid_planning"
SRC_URI = "git://github.com/moveit/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "ad4804f3afb7dd521faefe7b9ac56443293ab7db"
S = "${WORKDIR}/git"
