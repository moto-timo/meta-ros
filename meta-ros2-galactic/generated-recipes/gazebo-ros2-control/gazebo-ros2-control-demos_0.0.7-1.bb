...
# matches with: https://github.com/ros2-gbp/gazebo_ros2_control-release/archive/release/galactic/gazebo_ros2_control_demos/0.0.7-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/gazebo_ros2_control_demos"
SRC_URI = "git://github.com/ros2-gbp/gazebo_ros2_control-release;${ROS_BRANCH};protocol=https"
SRCREV = "cd2bd663717857205d26b523337d5ef4f58e4fcb"
S = "${WORKDIR}/git"
