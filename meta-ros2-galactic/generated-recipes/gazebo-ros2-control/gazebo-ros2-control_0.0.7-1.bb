...
# matches with: https://github.com/ros2-gbp/gazebo_ros2_control-release/archive/release/galactic/gazebo_ros2_control/0.0.7-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/gazebo_ros2_control"
SRC_URI = "git://github.com/ros2-gbp/gazebo_ros2_control-release;${ROS_BRANCH};protocol=https"
SRCREV = "759f0b12c1a7e9c66da9426459ddd877dadcfb62"
S = "${WORKDIR}/git"
