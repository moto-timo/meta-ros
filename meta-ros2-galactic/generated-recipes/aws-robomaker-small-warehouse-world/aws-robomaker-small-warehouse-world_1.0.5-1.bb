...
# matches with: https://github.com/aws-gbp/aws_robomaker_small_warehouse_world-release/archive/release/galactic/aws_robomaker_small_warehouse_world/1.0.5-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/aws_robomaker_small_warehouse_world"
SRC_URI = "git://github.com/aws-gbp/aws_robomaker_small_warehouse_world-release;${ROS_BRANCH};protocol=https"
SRCREV = "10fb0034016ab988bf89006a81db74933e4cd219"
S = "${WORKDIR}/git"
