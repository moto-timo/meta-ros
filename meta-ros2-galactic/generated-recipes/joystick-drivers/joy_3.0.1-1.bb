...
# matches with: https://github.com/ros2-gbp/joystick_drivers-release/archive/release/galactic/joy/3.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/joy"
SRC_URI = "git://github.com/ros2-gbp/joystick_drivers-release;${ROS_BRANCH};protocol=https"
SRCREV = "a29470d7dc2058d95c360717e23597747783d82c"
S = "${WORKDIR}/git"
