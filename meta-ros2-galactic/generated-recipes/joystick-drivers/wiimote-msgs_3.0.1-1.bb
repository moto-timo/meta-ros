...
# matches with: https://github.com/ros2-gbp/joystick_drivers-release/archive/release/galactic/wiimote_msgs/3.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/wiimote_msgs"
SRC_URI = "git://github.com/ros2-gbp/joystick_drivers-release;${ROS_BRANCH};protocol=https"
SRCREV = "173134db00fb72ac90f2fe7df6c98f521b2eba85"
S = "${WORKDIR}/git"
