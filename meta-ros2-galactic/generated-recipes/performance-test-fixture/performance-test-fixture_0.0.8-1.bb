...
# matches with: https://github.com/ros2-gbp/performance_test_fixture-release/archive/release/galactic/performance_test_fixture/0.0.8-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/performance_test_fixture"
SRC_URI = "git://github.com/ros2-gbp/performance_test_fixture-release;${ROS_BRANCH};protocol=https"
SRCREV = "833906040342b9d7a218b7140ab75c9c1e8c2509"
S = "${WORKDIR}/git"
