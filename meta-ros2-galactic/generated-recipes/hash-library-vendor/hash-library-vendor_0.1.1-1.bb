...
# matches with: https://github.com/ros2-gbp/hash_library_vendor-release/archive/release/galactic/hash_library_vendor/0.1.1-1.tar.gz
ROS_BRANCH ?= "branch=release/galactic/hash_library_vendor"
SRC_URI = "git://github.com/ros2-gbp/hash_library_vendor-release;${ROS_BRANCH};protocol=https"
SRCREV = "e4b9e148b33c043fd354623055e00411fa18a8f4"
S = "${WORKDIR}/git"
